...
class CaptureFrameResult {
  ...
  bool operator ==(Object other) {
    if (other is! CaptureFrameResult || other.runtimeType != runtimeType) {
      return false;
    }
    if (identical(this, other)) {
      return true;
    }
    return _deepEquals(rgba64, other.rgba64) && _deepEquals(pngPath, other.pngPath);
  }
  ...
  @override
  String toString() {
    return 'CaptureFrameResult(rgba64: $rgba64, pngPath: $pngPath)';
  }
}
...
class _PigeonCodec extends StandardMessageCodec {
  ...
  Object? readValueOfType(int type, ReadBuffer buffer) {
    switch (type) {
      case 129:
        return CaptureFrameResult.decode(readValue(buffer)!);
      default:
...
class VideoDecoderHostApi {
  /// Constructor for [VideoDecoderHostApi]. The [binaryMessenger] named argument is
